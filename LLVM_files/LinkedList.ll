...
%_7 = xor i1 1, %_17
	br i1 %_7, label %if0, label %else0
if0:
...
%_25 = xor i1 1, %_35
		br i1 %_25, label %if1, label %else1
if1:
			store i1 0, i1* %ret_val
			br label %endIf1
else1:
			...
			%_38 = load i1, i1* %_37
			br i1 %_38, label %if2, label %else2
if2:
...
%_39 = xor i1 1, %_46
				br i1 %_39, label %if3, label %else3
if3:
					store i1 0, i1* %ret_val
					br label %endIf3
else3:
...
else2:
				...
				br i1 %_53, label %if4, label %else4
if4:
					store i1 0, i1* %ret_val
					br label %endIf4
else4:
...
define i1 @Element.Compare(i8* %this, i32 %.num1, i32 %.num2){
	...
	br i1 %_4, label %if5, label %else5
if5:
		store i1 0, i1* %retval
		br label %endIf5
else5:
...
%_5 = xor i1 1, %_8
		br i1 %_5, label %if6, label %else6
if6:
			store i1 0, i1* %retval
			br label %endIf6
else6:
...
%_7 = xor i1 1, %_8
		br label %andClause0
andClause0:
		br i1 %_7, label %andClause1, label %andClause2
andClause1:
...
andClause2:
		br label %andClause3
andClause3:
%_11 = phi i1 [ 0, %andClause0 ], [ %_9, %andClause2 ]
		br i1 %_11, label %loop0, label %endLoop0
loop0:
		%_12 = load i8*, i8** %e
		...
		br i1 %_19, label %if7, label %else7
if7:
			store i1 1, i1* %ret_val
			%_20 = load i32, i32* %aux04
			%_21 = icmp slt i32 %_20, 0
			br i1 %_21, label %if8, label %else8
if8:
...
%_45 = xor i1 1, %_46
		br i1 %_45, label %if9, label %else9
if9:
...
%_6 = xor i1 1, %_7
		br i1 %_6, label %loop1, label %endLoop1
loop1:
		%_8 = load i8*, i8** %e
		...
		br i1 %_15, label %if10, label %else10
if10:
...
initLoop2:
				%_7 = load i1, i1* %var_end
%_6 = xor i1 1, %_7
		br i1 %_6, label %loop2, label %endLoop2
loop2:
