...
%_5 = xor i1 1, %_8
		br i1 %_5, label %if1, label %else1
if1:
			store i1 0, i1* %ntb
			br label %endIf1
else1:
...
initLoop1:
		%_0 = load i1, i1* %cont
		br i1 %_0, label %loop1, label %endLoop1
loop1:
...
%_45 = xor i1 1, %_52
					br label %andClause0
andClause0:
					br i1 %_45, label %andClause1, label %andClause2
andClause1:
...
initLoop3:
		...
		%_5 = bitcast i8* %_4 to i1 (i8*)*
		%_6 = call i1 %_5(i8* %_0)
		br i1 %_6, label %loop3, label %endLoop3
loop3:
		%_7 = load i8*, i8** %c_node
		%_8 = bitcast i8* %_7 to i8***
		%_9 = load i8**, i8*** %_8
...
initLoop4:
		%_0 = load i1, i1* %cont
		br i1 %_0, label %loop4, label %endLoop4
loop4:
		%_1 = load i8*, i8** %current_node
		%_2 = bitcast i8* %_1 to i8***
		%_3 = load i8**, i8*** %_2
